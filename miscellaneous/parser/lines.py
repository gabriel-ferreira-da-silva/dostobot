s1="""erving of contempt, you refuse to take a humane view of a fellow
...
hand, because it’s a sign of inequality. We had a debat"""

s2=""""запрещено...".

В подстрочном примечании к журнальной публикации первой части "Записок"

автор указал на связь своего "антигероя" с типом "лишнего человека".

Проблема "лишних людей", на смену которым шли новые герои-деятели,

активно обсуждалась в русской публицистике на рубеже 1860-х годов. Проявлял

к ней интерес и Достоевский. Так, имея в виду Чацкого и последовавших за ним

"лишних людей", Достоевский писал в "Зимних заметках"; "Они все ведь не

нашли дела, не находили два-три поколения сряду. Это факт, против факта и

говорить бы, кажется, нечего, но спросить из любопытства можно. Так вот не

понимаю я, чтоб умный человек, когда бы то ни было, при каких бы то ни было

обстоятельствах, не мог найти себе дела".

В то же время Достоевский осознавал и трагичность положения "лишних
"""

s3=""""
hich I spent my last half rouble, I drove up in grand style to the
Hôtel de Paris.
